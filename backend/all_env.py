...
POSTGRES_PORT = urllib.parse.quote_plus(str(os.environ.get('POSTGRES_PORT', '5432')))
POSTGRES_DB = os.environ.get('POSTGRES_DB', 'fastapi')
POSTGRES_USER = urllib.parse.quote_plus(str(os.environ.get('POSTGRES_USER', 'postgres')))
POSTGRES_PASS = urllib.parse.quote_plus(str(os.environ.get('POSTGRES_PASSWORD', 'secret')))
