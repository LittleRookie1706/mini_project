                ...
                <div class="w3-large">
                    ...
                    <div class="w3-container d-flex justify-center" id="where" style="padding-bottom:32px;">
                        <div class="w3-content" style="max-width:400px">
                            <!-- form action="/comment" target="_parent" method="post" -->
                            ...
                            <input class="w3-input w3-padding-16 w3-border rounded" id="comment" name="comment" type="text" placeholder="Bình luận" required style="min-height: 100px;">
                            <center>   
                                <button class="w3-button mt-2 rounded" type="button" onclick="add_comment()">Gửi bình luận</button>
                            </center>
                            <!-- /form -->
                        </div>
                    </div>
